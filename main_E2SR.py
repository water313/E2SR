...
def main():
    ...
    train_parser.add_argument("--epochs", type=int, default=200, help="epochs, default set to 150")
    ...
    train_parser.add_argument("--dataset_name", type=str, default="Chikusei",
                              help="dataset_name, default set to dataset_name")
    train_parser.add_argument("--model_title", type=str, default="E2SR",
    ...
    test_parser.add_argument("--dataset_name", type=str, default="Chikusei",
                             help="dataset_name, default set to dataset_name")
    test_parser.add_argument("--model_title", type=str, default="teacher",
                             help="model_title, default set to model_title")
...
def train(args):
    ...
    test_data_dir = './datasets32/' + args.dataset_name + '_x' + str(
    ...
    net = E2SR(n_colors=colors, n_feats=args.n_feats, n_lkb=args.n_blocks, scale=args.n_scale)
    # print(net)
    model_title = args.model_title + '_r' + str(args.n_scale) + '_Feats=' + str(args.n_feats) + '_lkb=' + str(
        args.n_blocks)
    ...
    model_name = './checkpoints/' + sanitized_time + '/' + args.dataset_name + '_' + model_title + "_ckpt_epoch_" + str(
        best_epoch) + ".pth"
